      ...
      <main id="main-content" className="pt-20">
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="prose prose-invert max-w-none">
            <p className="mb-4 text-tattoo-white">Last updated: {new Date().toLocaleDateString()}</p>
            
            <h2 className="text-2xl font-bold mt-8 mb-4 text-tattoo-white">1. Professional Service</h2>
            <p className="mb-4 text-tattoo-white">
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4 text-tattoo-white">2. Health Considerations</h2>
            <p className="mb-4 text-tattoo-white">
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4 text-tattoo-white">3. Content Accuracy</h2>
            <p className="mb-4 text-tattoo-white">
